/* ============================================================
   Fratelli Móveis — script único
   Cascavel, Paraná

   Duas metades: a biblioteca de animação, que não se edita, e o
   código do site. Procure pela faixa "CÓDIGO DO SITE" para achar
   onde começa a parte editável.
   ============================================================ */

/* ############################################################
   GSAP 3.13.0 + ScrollTrigger — biblioteca de animação.
   Licença padrão GSAP, sem custo. Não editar: para atualizar,
   troque o bloco inteiro pela versão nova de gsap.min.js e
...
/* ############################################################
   CÓDIGO DO SITE — a partir daqui é editável.
   ############################################################ */
/* ============================================================
...
(function () {
  ...
  /* A rede de segurança que removia os estados iniciais ficava aqui. Ela
     subiu para o <head> do index.html, inline: assim funciona mesmo quando
     este arquivo não chega a carregar. */
